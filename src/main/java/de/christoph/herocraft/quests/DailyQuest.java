...
/*     */ public class DailyQuest
    ...
    public static final List<Quest> questTemplates = Arrays.asList(
            new Quest[] {
                    ...
                    new BreakBlockQuest("Zerstöre 4 Ancient Debris", Material.ANCIENT_DEBRIS, 4),
                    new BreakBlockQuest("Zerstöre 20 Prismarinziegel", Material.PRISMARINE_BRICKS, 20),
                    new BreakBlockQuest("Zerstöre 50 Purpurblöcke", Material.PURPUR_BLOCK, 50),
                    new BreakBlockQuest("Zerstöre 100 Bruchstein", Material.COBBLESTONE, 100),
                    new BreakBlockQuest("Zerstöre 50 Quarz Erz", Material.NETHER_QUARTZ_ORE, 50),
                    ...
                    new BreakBlockQuest("Zerstöre 60 Glowstone", Material.GLOWSTONE, 60),
                    new BreakBlockQuest("Zerstöre 100 Knochenblöcke", Material.BONE_BLOCK, 100),
                    new BreakBlockQuest("Zerstöre 300 Sand", Material.SAND, 300),

                    new CatchFishQuest("Fange 5 Kugelfische", Material.PUFFERFISH, 5),
                    new CatchFishQuest("Fange 5 Tropenfische", Material.TROPICAL_FISH, 5),
                    new CatchFishQuest("Fange 10 Lachs", Material.SALMON, 10),
                    new CatchFishQuest("Fange 10 Kabeljau", Material.COD, 10),
                    ...
                    new CraftItemQuest("Stelle 16 Pfeile her", Material.ARROW, 16),
                    ...
                    new EatItemQuest("Iss 10 gebackene Kartoffeln", Material.BAKED_POTATO, 10),
                    new EatItemQuest("Iss 20 Kürbiskuchen", Material.PUMPKIN_PIE, 20),
                    new EatItemQuest("Iss 5 Pilzsuppen", Material.MUSHROOM_STEW, 5),
                    new EatItemQuest("Iss 10 verdorbene Fleischstücke", Material.ROTTEN_FLESH, 10),
                    new EatItemQuest("Iss 16 getrocknete Seetangblätter", Material.DRIED_KELP, 16),
                    ...
                    new FindBiomeQuest("Finde das Taiga-Biom", Biome.TAIGA),
                    new FindBiomeQuest("Finde das GefrorenerFluss-Biom", Biome.FROZEN_RIVER),
                    new FindBiomeQuest("Finde das SonnenblumenFläche-Biom", Biome.SUNFLOWER_PLAINS),
                    new FindBiomeQuest("Finde das Birkenwald-Biom", Biome.BEACH),
                    new FindBiomeQuest("Finde das Schwarzwald-Biom", Biome.DARK_FOREST),
                    new FindBiomeQuest("Finde das Lauwarmer-Ozean-Biom", Biome.LUKEWARM_OCEAN),
                    new FindBiomeQuest("Finde das Fluss-Biom", Biome.RIVER),
                    new FindBiomeQuest("Finde das Wüsten-Biom", Biome.DESERT),
                    new FindBiomeQuest("Finde das Ocean-Biom", Biome.OCEAN),
                    new FindBiomeQuest("Finde das Ende", Biome.THE_END),

                    new KillMobQuest("Töte 10 Witherskelette", EntityType.WITHER_SKELETON, 10),
                    new KillMobQuest("Töte 15 Endermänner", EntityType.ENDERMAN, 15),
                    new KillMobQuest("Töte 25 Ertrunkene", EntityType.DROWNED, 25),
                    new KillMobQuest("Töte 20 Zombies", EntityType.ZOMBIE, 20),
                    new KillMobQuest("Töte 10 WüstenZombies", EntityType.HUSK, 10),
                    new KillMobQuest("Töte 20 Skelete", EntityType.SKELETON, 20),
                    new KillMobQuest("Töte 20 Creeper", EntityType.CREEPER, 20),
                    new KillMobQuest("Töte 1 Warden", EntityType.WARDEN, 1),
                    new KillMobQuest("Töte 15 Spinnen", EntityType.SPIDER, 15),
                    new KillMobQuest("Töte 5 PiglinBabaren", EntityType.PIGLIN_BRUTE, 5),
                    new KillMobQuest("Töte 2 Shulker", EntityType.SHULKER, 2),
...
/* 534 */               .getInt(questDescription + "." + questDescription, 0));
    ...
    /*     */   public void onPlayerQuit(PlayerQuitEvent event) {
        /* 549 */     this.playerQuests.remove(event.getPlayer().getUniqueId());
        /*     */   }

    /*     */   private boolean isNewQuestDay(long last, long now) {
        /* 553 */     if (last <= 0L) {
            /* 554 */       return true;
            /*     */     }
        /* 556 */     LocalDate lastDate = Instant.ofEpochMilli(last).atZone(ZoneId.systemDefault()).toLocalDate();
        /* 557 */     LocalDate nowDate = Instant.ofEpochMilli(now).atZone(ZoneId.systemDefault()).toLocalDate();
        /* 558 */     return nowDate.isAfter(lastDate);
        /*     */   }
    /*     */
    ...
    /*     */   public void completeQuest(Player player, Quest quest) {
        ...
        /* 607 */     if (new Random().nextDouble() < 0.35D) {
            /* 608 */       setChestsForPlayer(player, getChestsFromPlayer(player) + 1);
            /* 609 */       player.sendMessage("§e§lAnyBlocks §7§l| §0[§a+§0] §71 SurvivalLands Kiste");
            /*     */     }
        /*     */
        /*     */
        ...
        /* 625 */     HeroCraft.getPlugin().getStatisticsManager().markQuestCompleted(player.getUniqueId());
